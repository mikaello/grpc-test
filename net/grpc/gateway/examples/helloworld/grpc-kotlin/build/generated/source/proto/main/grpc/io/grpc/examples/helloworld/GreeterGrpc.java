...
public final class GreeterGrpc {
  ...
  public static final String SERVICE_NAME = "io.grpc.examples.helloworld.Greeter";
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.helloworld.RepeatHelloRequest,
      io.grpc.examples.helloworld.HelloReply> getSayRepeatHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayRepeatHello",
      requestType = io.grpc.examples.helloworld.RepeatHelloRequest.class,
      responseType = io.grpc.examples.helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.examples.helloworld.RepeatHelloRequest,
      io.grpc.examples.helloworld.HelloReply> getSayRepeatHelloMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.helloworld.RepeatHelloRequest, io.grpc.examples.helloworld.HelloReply> getSayRepeatHelloMethod;
      ...
      synchronized (GreeterGrpc.class) {
        if ((getSayRepeatHelloMethod = GreeterGrpc.getSayRepeatHelloMethod) == null) {
          GreeterGrpc.getSayRepeatHelloMethod = getSayRepeatHelloMethod =
              io.grpc.MethodDescriptor.<io.grpc.examples.helloworld.RepeatHelloRequest, io.grpc.examples.helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayRepeatHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.RepeatHelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.HelloReply.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayRepeatHello(io.grpc.examples.helloworld.RepeatHelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                io.grpc.examples.helloworld.RepeatHelloRequest,
                io.grpc.examples.helloworld.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<io.grpc.examples.helloworld.HelloReply> sayRepeatHello(
        io.grpc.examples.helloworld.RepeatHelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAY_REPEAT_HELLO:
          serviceImpl.sayRepeatHello((io.grpc.examples.helloworld.RepeatHelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply>) responseObserver);
          break;
        default:
